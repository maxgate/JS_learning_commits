...
/*
////////////////////////////////////
// Promisifying the Geolocaton API
...
(async function () {
  try {
    const city = await whereAmI('nigeria');
    console.log(`2: ${city}`);
  } catch (err) {
...
get3Countries('nigeria', 'india', 'usa');
*/
...
(async function () {
  const res = await Promise.race([
    getJSON(`https://restcountries.com/v2/name/togo`),
